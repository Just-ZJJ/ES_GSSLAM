...
class ReplicaDataset(GradSLAMDataset):
    ...
    def get_filepaths(self):
        ...
        semantic_id_paths = natsorted(glob.glob(f"{self.input_folder}/semantic_ids/semantic_id*.png"))
        semantic_color_paths = natsorted(glob.glob(f"{self.input_folder}/semantic_colors/semantic_color*.png"))
        # gt_semantic_id_paths = natsorted(glob.glob(f"{self.input_folder}/gt_semantic_ids/semantic_id*.png"))
        # gt_semantic_color_paths = natsorted(glob.glob(f"{self.input_folder}/semantic_colors/semantic_color*.png"))
