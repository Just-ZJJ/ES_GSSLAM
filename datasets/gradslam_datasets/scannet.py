...
class ScannetDataset(GradSLAMDataset):
    ...
    def get_filepaths(self):
        ...
        # gt_semantic_paths = natsorted(glob.glob(f"{self.input_folder}/gt_semantic_color/*.png"))
        # gt_semantic_id_paths = natsorted(glob.glob(f"{self.input_folder}/gt_semantic_id/*.png"))
